...
// Chart type mapping
// Fix: Updated chart type strings from kebab-case to camelCase to match valid export identifiers.
const CHART_TYPE_MAP = {
  generate_area_chart: "area",
  generate_bar_chart: "bar",
  generate_boxplot_chart: "boxplot",
  generate_column_chart: "column",
  generate_district_map: "districtMap",
  generate_dual_axes_chart: "dualAxes",
  generate_fishbone_diagram: "fishboneDiagram",
  generate_flow_diagram: "flowDiagram",
  generate_funnel_chart: "funnel",
  generate_histogram_chart: "histogram",
  generate_line_chart: "line",
  generate_liquid_chart: "liquid",
  generate_mind_map: "mindMap",
  generate_network_graph: "networkGraph",
  generate_organization_chart: "organizationChart",
  generate_path_map: "pathMap",
  generate_pie_chart: "pie",
  generate_pin_map: "pinMap",
  ...
  generate_word_cloud_chart: "wordCloud",
} as const;
