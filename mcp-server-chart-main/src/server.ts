...
// Fix: Add an explicit import for 'process' from 'node:process' to ensure correct TypeScript types are available for `process.on` and `process.exit`, resolving "Property does not exist" errors.
