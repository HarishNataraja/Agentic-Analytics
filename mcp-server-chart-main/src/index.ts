...
// Fix: Add an explicit import for 'process' from 'node:process' to ensure correct TypeScript types are available for `process.exit`, resolving a "Property 'exit' does not exist" error.
